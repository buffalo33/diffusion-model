...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov  3 08:18:38 2022
...
from diffusion_utils import conv2d, group_norm, dense
...
class UNet(nn.Module):
    def __init__(self,
        ...
        for i_level in range(num_resolutions):
            ...
            for i_block in range(num_res_blocks):
                ...
                if in_ht in attn_resolutions:
                    block_modules['{}a_{}b_attn'.format(i_level, i_block)] = Attention(out_ch, normalize=normalize)
                unet_chs += [out_ch]
                in_ch = out_ch
            # Downsample
        ...
        mid_modules += [Attention(in_ch, normalize=normalize)]
        mid_modules += [
            ResidualBlock(in_ch, temb_ch=temb_ch, out_ch=in_ch, dropout=dropout, act=act, normalize=normalize)]
